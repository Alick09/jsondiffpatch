...
class JSONFormatter extends BaseFormatter {
    ...
    prepareContext(context: any) {
        super.prepareContext(context);
        context.result = [];
        context.path = [];
        context.pushCurrentOp = function(obj: any) {
            const {op, value} = obj;
            const val: any = {
                op,
        ...
        context.pushMoveOp = function(to: any) {
        ...
        context.toPath = function(toPath: string) {
    ...
    typeFormattterErrorFormatter(context: any, err: string) {
    ...
    nodeBegin({path}: any, key: any, leftKey: any) {
        path.push(leftKey);
    }
